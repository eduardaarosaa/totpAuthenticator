...
$result = Google2FA::verify_key($InitalizationKey, "714548");

var_dump($result);
echo "<br><br>";
$carteira = "otpauth://totp/ABESTAIADINHO?secret=$InitalizationKey";
...
echo "</div>";
echo "<form action='totpClass.php' method='POST'>";
echo "<input type='text' name='codigo' id='codigo' placeholder='Codigo'>";
echo "<input type='hidden' name='otp' id='otp' value='$otp'>";
